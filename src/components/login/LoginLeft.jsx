...
const LoginLeft = () => {
  ...
  return (
    <form onSubmit={e => {
    ...
    }} className="pt-5 lg:pl-40 lg:pr-30 h-full relative px-[15px] flex flex-col">
      <Logo />
      <div className="flex-1 flex flex-col justify-center">
        <h1 className="text-6xl font-bold text-grey-text leading-20.5">Login</h1>
      ...
      <div className="flex justify-center w-full pb-8 lg:pb-10">
